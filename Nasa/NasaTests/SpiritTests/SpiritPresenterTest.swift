...
class SpiritPresenterTest: XCTestCase {

    var presenter: SpiritPresenter!
    var view: MockSpiritViewController!
    var interactor: MockSpiritInteractor!
